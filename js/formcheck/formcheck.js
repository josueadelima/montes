...
// REGISTRE EL ELEMENTO el.get('tag') == 'a' para poder hacer <a class="validate['submit']">Un boton de mi framework </a>
//Josué A. de Lima ;)


			this.form.getElements("*[class*=validate]").each(function(el) {
				if (el.get('tag') == 'select' || el.get('tag') == 'input' || el.get('tag') == 'textarea' || el.get('tag') == 'a' || el.get('tag') == 'div') this.register(el);
			}, this);
